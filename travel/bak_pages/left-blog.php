    ...
    <div class="breadcrumbs1_wrapper">
        <div class="container">
            <div class="breadcrumbs1"><a
                        href="https://demo.gridgum.com/templates/Travel-agency/index.html">Home</a><span>/</span>Blog
            </div>
        </div>
    </div>
                        ...
                        <div class="post post-short">
                            ...
                            <div class="post-story">
                                ...
                                <div class="post-story-link">
                                    <a href="https://demo.gridgum.com/templates/Travel-agency/post.html"
                                       class="btn-default btn4">view post</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="blog_sidebar">
                        ...
                        <ul class="users clearfix">
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users1.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users2.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users3.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users4.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users5.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users6.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users7.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                            <li><a href="#">
                                    <figure><img
                                                src="https://demo.gridgum.com/templates/Travel-agency/images/users8.jpg"
                                                alt="" class="img-responsive"><em></em></figure>
                                </a></li>
                        </ul>
