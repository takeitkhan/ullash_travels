                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade h-100"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item">
                                            <img src="./images/single_event_card/1.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item active">
                                            <img src="./images/single_event_card/2.png" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="./images/single_event_card/3.png" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
